      ...
      <div className="max-w-7xl mx-auto px-6">
          ...
          <div>
            ...
            <div className="space-y-3 text-[13px] text-[#666]">
              ...
              <div className="flex items-center gap-2">
                <span>📞</span>
                <a href={`tel:${COMPANY.phone}`} className="hover:text-[#d4a820] transition-colors">{COMPANY.phone}</a>
              </div>
              <div className="flex items-center gap-2">
                <span>📧</span>
                <a href={`mailto:${COMPANY.email}`} className="hover:text-[#d4a820] transition-colors">{COMPANY.email}</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-[rgba(212,168,32,0.1)] pt-6 flex flex-col md:flex-row justify-between items-center gap-3">
          <p className="text-[11px] text-[#444]">
            © 2024 Jaybhadra Builders. All rights reserved. | Sangamner, Maharashtra, India
          </p>
