...
export const PROJECTS: Project[] = [
  {
    ...
    highlights: ['Premium 2BHK & 3BHK Apartments', 'Modern Architecture', 'Quality Construction', 'Prime Location', 'Vastu Compliant', 'Car Parking'],
    amenities: ['24/7 Security', 'Power Backup', 'Water Supply', 'Garden Area', 'Children Play Area', 'Visitor Parking'],
    gallery: [
      'https://jaybhadrabuilders.com/wp-content/uploads/2024/10/1-3.png',
    ],
  },
  {
    id: 2,
    ...
    gallery: [
      'https://jaybhadrabuilders.com/wp-content/uploads/2024/10/2-3.png',
    ],
  },
  {
    id: 3,
    ...
    highlights: ['Upgraded Amenities', 'Better Finishing', 'Improved Design', 'Prime Location', '2BHK & 3BHK Options', 'Vastu Compliant'],
    amenities: ['24/7 Security', 'Power Backup', 'Water Supply', 'Garden Area', 'Children Play Area', 'Car Parking'],
    gallery: [
      'https://jaybhadrabuilders.com/wp-content/uploads/2024/10/3-1.png',
    ],
  },
  {
    id: 4,
    ...
    gallery: [
      'https://jaybhadrabuilders.com/wp-content/uploads/2024/10/4-1.png',
    ],
  },
  {
    id: 5,
    ...
    amenities: ['Water Supply', 'Power Backup', 'Security', 'Parking', 'Street Lighting', 'Drainage'],
    gallery: [
      'https://jaybhadrabuilders.com/wp-content/uploads/2024/10/5-1.png',
    ],
  },
  {
    id: 6,
    ...
    highlights: ['Spacious Homes', 'Peaceful Location', 'Top Quality', 'Open Spaces', 'Well Connected', 'Premium Finishing'],
    amenities: ['Water Supply', 'Power Backup', 'Security', 'Parking', 'Garden', 'Children Play Area'],
    gallery: [
      'https://jaybhadrabuilders.com/wp-content/uploads/2024/10/7.png',
    ],
  },
  {
    id: 7,
    slug: 'golden-city-sangamner-ongoing',
    ...
    fullDescription: 'This is the flagship ongoing project of Jaybhadra Builders — a large-scale residential and commercial development in Sangamner. The project features Wing A with 24 residential units, Wing B and C with 42 residential units, and 12 ground floor commercial shops. An excellent investment opportunity with limited availability.',
    highlights: ['Wing A — 24 Units', 'Wing B & C — 42 Units', '12 Commercial Shops', 'Prime Location', '2BHK & 3BHK Options', 'Limited Units Left'],
    amenities: ['24/7 Security', 'Power Backup', 'Water Supply', 'Lift', 'Car Parking', 'CCTV Surveillance'],
    urgency: 'Limited units available!',
    gallery: [
      'https://jaybhadrabuilders.com/wp-content/uploads/2025/04/1.png',
    ],
  },
  {
    id: 8,
    ...
    highlights: ['Modern Design', 'Affordable Pricing', 'Quality Construction', 'Good Connectivity', 'Family Friendly', 'Booking Open'],
    amenities: ['Water Supply', 'Power Backup', 'Security', 'Parking', 'Children Play Area', 'Garden'],
    urgency: 'Booking open now!',
    gallery: [
      'https://jaybhadrabuilders.com/wp-content/uploads/2025/04/2.png',
    ],
  },
  {
    id: 9,
    ...
    fullDescription: 'Rahane Mala is an exciting upcoming residential project by Jaybhadra Builders. Located in one of Sangamner most sought-after areas, this project promises premium construction quality with modern design aesthetics. Early investors benefit from pre-launch pricing and best unit selection.',
    highlights: ['Premium Construction', 'Modern Design', 'Sought-After Location', 'Pre-launch Pricing', 'Best Unit Selection', 'Early Bird Offer'],
    amenities: ['24/7 Security', 'Power Backup', 'Water Supply', 'Parking', 'Garden', 'Children Play Area'],
    urgency: 'Pre-launch offer!',
    gallery: [
      'https://jaybhadrabuilders.com/wp-content/uploads/2025/04/4.png',
    ],
  },
  {
    id: 10,
    ...
    gallery: [
      'https://jaybhadrabuilders.com/wp-content/uploads/2025/04/3.png',
    ],
  },
  {
    id: 11,
    ...
    gallery: [
      'https://jaybhadrabuilders.com/wp-content/uploads/2025/04/6.png',
    ],
  },
  {
    id: 12,
